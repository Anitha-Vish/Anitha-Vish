import Nwsl from "../assets/Nwsl.png";
  ...
  return (
    ...
    >
      <div class=" flex flex-col justify-center ">
        ...
        <span>
          <button class="bg-orange-500 text-white px-4 py-2 rounded-lg shadow-md mx-40 mt-10 hover:bg-green-500">
            Our Story
          </button>
        </span>
      </div>
